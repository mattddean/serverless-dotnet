...
module.exports = {
  pack() {
    ...
    this.serverless.cli.log('servicePath: ')
    this.serverless.cli.log(servicePath)
    this.serverless.cli.log('hasPackage: ')
    this.serverless.cli.log(this.options.hasOwnProperty('package'))
    this.serverless.cli.log('this.options.package: ')
    this.serverless.cli.log(this.options.package)
    ...
    this.serverless.cli.log('artifactDirectoryPath: ')
    this.serverless.cli.log(artifactDirectoryPath)
